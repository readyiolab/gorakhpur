...
export default function Services({ onNavigate }: ServicesProps) {
  ...
  return (
    <div className="min-h-screen ">
      {/* Services Hero Section - Full Parallax & Immersive (with Services content) */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-24">
            {services.map((service, index) => (
              <div
                key={index}
                className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center transition-all duration-700 ${servicesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                  }`}
